...
public:
    ...
    bool isFiveOfAKind() {
        for (const auto& pair : rankCount) {
            if ( (pair.first !='J' && ( (pair.second + rankCount['J']) == 5)) || pair.second == 5) {
                return true;
            }
        }
        return false;
    ...
    bool isFourOfAKind() {
        for (const auto& pair : rankCount) {
            if ((pair.first !='J' && ((pair.second + rankCount['J']) == 4)) || pair.second == 4) {
                return true;
            }
        }
        return false;
    ...
    bool isFullHouse() {
        ...
        for (const auto& pair : rankCount) {
            if ((pair.first !='J' && !j_used && ((pair.second + rankCount['J']) == 3)) || pair.second == 3) {
                hasThree = true;
                if(pair.second!=3){
                    j_used = true;
                }
    ...
    bool isThreeOfAKind() {
        for (const auto& pair : rankCount) {
            if ((pair.first !='J' && ((pair.second + rankCount['J']) == 3)) || pair.second == 3) {
                return true;
            }
        }
        return false;
    ...
    bool isOnePair() {
        ...
        for (const auto& pair : rankCount) {
            if ((pair.first !='J' && !j_used && ((pair.second + rankCount['J']) == 2)) || pair.second == 2) {
                pairCount++;
                if(pair.second!=2)
                    j_used = true;
            }
...
int main() {
    ...
    for (size_t i = 0; i < hands.size(); ++i) {
        std::cout << "pos: " << i << " hand: " << hands[i].getHand() << " bid: "<< hands[i].getBid() << " type: " << hands[i].getType()<< std::endl;
